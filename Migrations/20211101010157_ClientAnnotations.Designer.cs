...
namespace RazorPages.Migrations
{
    ...
    [Migration("20211101010157_ClientAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 21, 1, 57, 324, DateTimeKind.Local).AddTicks(8956),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2021, 10, 31, 21, 1, 57, 329, DateTimeKind.Local).AddTicks(7934),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 31, 21, 1, 57, 329, DateTimeKind.Local).AddTicks(8026),
                            ServicesID = 5
                        });
                });
