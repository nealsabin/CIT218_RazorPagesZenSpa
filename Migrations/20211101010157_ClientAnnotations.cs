    ...
    public partial class ClientAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2021, 10, 31, 21, 1, 57, 324, DateTimeKind.Local).AddTicks(8956), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2021, 10, 31, 21, 1, 57, 329, DateTimeKind.Local).AddTicks(8026), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2021, 10, 31, 21, 1, 57, 329, DateTimeKind.Local).AddTicks(7934), 7 });
